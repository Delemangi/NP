...
public class LogSystem<T> {
    ...
    void printResults() {
        LogProcessor<String> firstLogProcessor = logsList.stream().filter(i -> i.get)

        LogProcessor<String> secondLogProcessor = ;

        LogProcessor<String> thirdLogProcessor = ;
